...
3. (Optional) Edit the books source files located in the `polar_eo/` directory
4. Run `jupyter-book clean polar_eo/` to remove any existing builds
5. Run `jupyter-book build polar_eo/`

A fully-rendered HTML version of the book will be built in `polar_eo/_build/html/`.
